...
const images = {
    ...
    profile: {
        ...
        ic_history_request: require('res/images/icon/profile/ic_history_request.png'),
        ic_ranking: require('res/images/icon/profile/ic_ranking.png'),
        ...
        ic_book: require('res/images/icon/profile/ic_book.png'),
